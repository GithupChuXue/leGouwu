<template>
  <div class="pay-main">
    <div class="pay-container">
      <el-button type="" icon="el-icon-star-on">测试</el-button>
...
export default {
  ...
  methods: {
    async getPayInfo() {
      let promise = await this.$API.reqPayInfo(this.orderId);
      // 如果去请求成功
      if (promise.code == 200) {
        // 将获取到的信息存储在组件实例里
        this.payInfo = promise.data;
        return "ok";
      } else {
